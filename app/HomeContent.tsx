...
function Hero() {
    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center pt-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-20 text-white flex flex-col items-center justify-center min-h-screen">
...
function Services() {
    const services = [
        ...
        },
        {
            ...
            imageUrl: 'https://images.unsplash.com/photo-1518331393666-6b22b6473b63?q=80&w=2070&auto=format&fit=crop',
